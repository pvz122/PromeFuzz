...
int LLVMFuzzerTestOneInput_27(const uint8_t *Data, size_t Size) {
    ...
    uLong adler2 = adler32(adler1, (const Bytef *)Data, Size);

    // adler32_combine
    uLong adler3 = adler32(0L, (const Bytef *)Data, Size / 2);
    uLong adler4 = adler32(0L, (const Bytef *)Data + Size / 2, Size - Size / 2);
    uLong combined_adler = adler32_combine(adler3, adler4, Size - Size / 2);

    // crc32_combine_op
    uLong crc1 = crc32(0L, Z_NULL, 0);
    uLong crc2 = crc32(crc1, (const Bytef *)Data, Size / 2);
    uLong crc3 = crc32(crc2, (const Bytef *)Data + Size / 2, Size - Size / 2);
    uLong op = crc32_combine_gen(Size - Size / 2);
    uLong combined_crc = crc32_combine_op(crc2, crc3, op);

    // adler32_z
    uLong adler5 = adler32_z(0L, (const Bytef *)Data, Size);

    // crc32_z
    uLong crc4 = crc32_z(0L, (const Bytef *)Data, Size);

    // crc32
    uLong crc5 = crc32(0L, Z_NULL, 0);
    uLong crc6 = crc32(crc5, (const Bytef *)Data, Size);
