...
extern "C" int LLVMFuzzerTestOneInput_147(const uint8_t *Data, size_t Size) {
    ...
    cmsGetPostScriptColorResource(context, cmsPS_RESOURCE_CSA, hProfile, renderingIntent, 0, io);
    cmsGetPostScriptColorResource(context, cmsPS_RESOURCE_CRD, hProfile, renderingIntent, 0, io);
