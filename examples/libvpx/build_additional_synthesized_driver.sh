...
cd /promefuzz
# aflpp
AFL_LLVM_USE_TRACE_PC=1 AFL_USE_ASAN=1 $AFLPP_PATH/afl-clang-fast *.c -o /promefuzz/database/libvpx/latest/out/fuzz_driver/aflpp_synthesized_driver $AFLPP_LIB_PATH -g -I/promefuzz/database/libvpx/latest/code/vpx database/libvpx/latest/bin_aflpp/lib/libvpx.a -Idatabase/libvpx/latest/code
# gcov
