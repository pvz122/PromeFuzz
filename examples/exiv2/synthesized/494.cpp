...
extern "C" int LLVMFuzzerTestOneInput_494(const uint8_t *Data, size_t Size) {
    ...
    try {
        ...
        // Call toRational() with a small index to avoid out-of-bounds
        ...
        // Call toUint32() with a small index to avoid out-of-bounds
        size_t n_uint32 = Data[0] % 16;
        valueType.toUint32(n_uint32);

        // Call toInt64() with a small index to avoid out-of-bounds
        size_t n_int64 = Data[0] % 16;
        valueType.toInt64(n_int64);

        // Call toString() with a small index to avoid out-of-bounds
