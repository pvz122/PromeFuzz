...
extern "C" int LLVMFuzzerTestOneInput_33(const uint8_t *Data, size_t Size) {
    ...
    int unit_type;
    png_uint_32 phys_result = png_get_pHYs(png_ptr, info_ptr, &res_x, &res_y, &unit_type);

    png_uint_32 maxCLL, maxFALL;
    png_uint_32 cLLI_result = png_get_cLLI_fixed(png_ptr, info_ptr, &maxCLL, &maxFALL);

    png_uint_32 valid_result = png_get_valid(png_ptr, info_ptr, PNG_INFO_pHYs);
